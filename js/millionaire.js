let questions = {
    extraEasy: [
        ...
        {
            "question": "<Հեղնար աղբյուր> ֆիլմում ինչ էր Հեղնարի ամուսնու անունը?",
            "content": [
                "Մկրտիչ",
                "Դավիթ",
                "Արմեն ",
    ...
    easy: [
        ...
        {
            "question": "Ում ոչխարն է կորում <Մենք ենք մեր սարերը> ֆիլմում?",
            "content": [
                "Զավենի ",
                "Պավլենի ",
                "Իշխանի ",
    ...
    medium: [
        ...
        {
            "question": "<Տժվժիկ> ֆիլմի սցենարը որ պատմվածքի հիման վրա է նկարահանված?",
            "content": [
                "Ատրպետի  ",
                "Նարեկի ",
                "Գրիգորի ",
